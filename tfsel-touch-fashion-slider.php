 ...
 * Plugin URI:        https://themeforest.net/user/teknofraction
 * Description:       Ultimate Touch Fashion Slider - elementor add-on to add an attracting slider to your website.
 * Version:           1.0.0
 * Author:            Tekno Fraction
 * Author URI:        https://themeforest.net/user/teknofraction
			...
			foreach ( $notices as $notice ) { ?>
				<div class='notice notice-success is-dismissible'>
					...
					<p>
						...
						<a target="_blank" href="<?php printf( esc_url( 'https://codecanyon.net/user/teknofraction/portfolio' ) ); ?>">
							<?php printf( esc_html( 'Here!' ) ); ?>
						</a>
					</p>
					<a target="_blank"  href="<?php printf( esc_url( 'https://profiles.wordpress.org/teknofraction/' ) ); ?>" target="_blank" class="rating-link">
					<strong>
